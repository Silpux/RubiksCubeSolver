...
public class CameraRotator : MonoBehaviour{
    ...
    private void Zoom(int zoom){
        ...
        transform.position = transform.rotation * new Vector3(0, 0, -distanceFromCenter) - (cameraInputHandler.IsSideView ? transform.up * distanceFromCenter / 12 - transform.right * 2 : Vector3.zero);
    ...
    private void ApplyRotation(Vector2 delta){
        ...
        transform.position = transform.rotation * new Vector3(0f, 0, -distanceFromCenter) - (cameraInputHandler.IsSideView ? transform.up * distanceFromCenter / 12 - transform.right * 2 : Vector3.zero);
    }
