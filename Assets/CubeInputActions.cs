...
public partial class @CubeInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Click"",
                    ""type"": ""Button"",
                    ""id"": ""962af923-1fc2-4e92-9bbe-cf9b4b25e94b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""e8462322-0bb5-460a-8357-74222ca80ce0"",
    ...
    ""controlSchemes"": [
        ...
        m_Cube_Look = m_Cube.FindAction("Look", throwIfNotFound: true);
        m_Cube_Interact = m_Cube.FindAction("Interact", throwIfNotFound: true);
        m_Cube_Crouch = m_Cube.FindAction("Crouch", throwIfNotFound: true);
    ...
    ~@CubeInputActions()
    {
        UnityEngine.Debug.Assert(!m_Cube.enabled, "This will cause a leak and performance issues, CubeInputActions.Cube.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, CubeInputActions.UI.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Cube_Look;
    private readonly InputAction m_Cube_Interact;
    private readonly InputAction m_Cube_Crouch;
    ...
    public struct CubeActions
    {
        ...
        public InputAction @Look => m_Wrapper.m_Cube_Look;
        public InputAction @Interact => m_Wrapper.m_Cube_Interact;
        public InputAction @Crouch => m_Wrapper.m_Cube_Crouch;
    ...
    {
        private @CubeInputActions m_Wrapper;
        public UIActions(@CubeInputActions wrapper) { m_Wrapper = wrapper; }
